...
AFRAME.registerComponent('hand-controls-kgd', {
  ...
  update: function (previousHand) {
    ...
    console.log("Updating gesture from " + this.data.gesture + " to " + this.data.lastGesture)
  ...
  animateGesture: function (gesture, lastGesture) {
    ...
    this.el.setAttribute("hand-animator", {gesture: gesture, lastGesture: lastGesture, gestureComplex: gesture + '__' + lastGesture, flipper: !flipper})
