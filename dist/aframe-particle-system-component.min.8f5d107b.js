...
})({"aa682a65de516c6a89d218144bb70545":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "8f5d107bd8f8223c2356d34558bee33a";
...
},{}],"b88ced830de1fd4a4f89fa862763f707":[function(require,module,exports) {
!function (e) {
  function t(i) {
  ...
  var r = {};
  t.m = e, t.c = r, t.d = function (e, r, i) {
  ...
  AFRAME.registerComponent("particle-system", {
    ...
    update: function (e) {
      ...
      this.initParticleSystem(this.data), !0 === this.data.enabled ? this.startParticles() : this.stopParticles();
    },
    ...
    initParticleSystem: function (e) {
      ...
      var a = new i.Emitter({
        ...
        position: {
          spread: new THREE.Vector3(e.positionSpread.x, e.positionSpread.y, e.positionSpread.z),
        ...
        acceleration: {
          value: new THREE.Vector3(e.accelerationValue.x, e.accelerationValue.y, e.accelerationValue.z),
          spread: new THREE.Vector3(e.accelerationSpread.x, e.accelerationSpread.y, e.accelerationSpread.z)
        },
        velocity: {
          value: new THREE.Vector3(e.velocityValue.x, e.velocityValue.y, e.velocityValue.z),
          spread: new THREE.Vector3(e.velocitySpread.x, e.velocitySpread.y, e.velocitySpread.z)
        },
        drag: {
          value: new THREE.Vector3(e.dragValue.x, e.dragValue.y, e.dragValue.z),
          spread: new THREE.Vector3(e.dragSpread.x, e.dragSpread.y, e.dragSpread.z),
  ...
  i = o, void 0 !== (a = "function" == typeof i ? i.call(t, r, t, e) : i) && (e.exports = a), o.TypedArrayHelper = function (e, t, r, i) {
    "use strict";
  ...
  }, o.TypedArrayHelper.constructor = o.TypedArrayHelper, o.TypedArrayHelper.prototype.setSize = function (e, t) {
    "use strict";
    ...
    null !== this.typedArray && this.typedArray.size === e * this.componentSize || (null !== this.typedArray && this.typedArray.size !== e ? this.typedArray.setSize(e) : null === this.typedArray && (this.typedArray = new o.TypedArrayHelper(this.arrayType, e, this.componentSize)));
  }, o.ShaderAttribute.prototype._createBufferAttribute = function (e) {
    "use strict";

    if (this._ensureTypedArray(e), null !== this.bufferAttribute) return this.bufferAttribute.array = this.typedArray.array, void (this.bufferAttribute.needsUpdate = !0);
    ...
    zeroToEpsilon: function (e, t) {
      ...
      var r = e;
      return r = t ? 1e-5 * Math.random() * 10 : 1e-5, e < 0 && e > -1e-5 && (r = -r), r;
    },
    ...
    randomVector3: function (e, t, r, i, a) {
      ...
      var o = r.x + (Math.random() * i.x - .5 * i.x),
          s = r.y + (Math.random() * i.y - .5 * i.y),
          n = r.z + (Math.random() * i.z - .5 * i.z);
      a && (o = .5 * -a.x + this.roundToNearestMultiple(o, a.x), s = .5 * -a.y + this.roundToNearestMultiple(s, a.y), n = .5 * -a.z + this.roundToNearestMultiple(n, a.z)), e.typedArray.setVec3Components(t, o, s, n);
    },
    ...
    randomColorAsHex: function () {
      ...
      return function (t, r, i, a) {
        for (var o = i.length, s = [], n = 0; n < o; ++n) {
          var u = a[n];
          e.copy(i[n]), e.r += Math.random() * u.x - .5 * u.x, e.g += Math.random() * u.y - .5 * u.y, e.b += Math.random() * u.z - .5 * u.z, e.r = this.clamp(e.r, 0, 1), e.g = this.clamp(e.g, 0, 1), e.b = this.clamp(e.b, 0, 1), s.push(e.getHex());
        }
    ...
    for (r; r >= 0; --r) e = t[r], i.SHOULD_CALCULATE_SPRITE || (i.SHOULD_ROTATE_TEXTURE = i.SHOULD_ROTATE_TEXTURE || !!Math.max(Math.max.apply(null, e.angle.value), Math.max.apply(null, e.angle.spread))), i.SHOULD_ROTATE_PARTICLES = i.SHOULD_ROTATE_PARTICLES || !!Math.max(e.rotation.angle, e.rotation.angleSpread), i.SHOULD_WIGGLE_PARTICLES = i.SHOULD_WIGGLE_PARTICLES || !!Math.max(e.wiggle.value, e.wiggle.spread);
    ...
    for (var o in r) r.hasOwnProperty(o) && (e = r[o], t = a[o], t ? t.array = e.typedArray.array : i.addAttribute(o, e.bufferAttribute), e.bufferAttribute.needsUpdate = !0);
    ...
    var t = this.attributes,
        ...
        i = r + e.particleCount;
    this.particleCount = i, null !== this.maxParticleCount && this.particleCount > this.maxParticleCount && console.warn("SPE.Group: maxParticleCount exceeded. Requesting", this.particleCount, "particles, can support only", this.maxParticleCount), e._calculatePPSValue(e.maxAge._value + e.maxAge._spread), e._setBufferUpdateRanges(this.attributeKeys), e._setAttributeOffset(r), e.group = this, e.attributes = this.attributes;
    ...
    for (var s = r; s < i; ++s) e._assignPositionValue(s), e._assignForceValue(s, "velocity"), e._assignForceValue(s, "acceleration"), e._assignAbsLifetimeValue(s, "opacity"), e._assignAbsLifetimeValue(s, "size"), e._assignAngleValue(s), e._assignRotationValue(s), e._assignParamsValue(s), e._assignColorValue(s);
    ...
    if (e instanceof o.Emitter == !1) return void console.error("`emitter` argument must be instance of SPE.Emitter. Was provided with:", e);
    if (-1 === t) return void console.error("Emitter does not exist in this group. Will not remove.");
    ...
    return e.length ? e.pop() : t ? new o.Emitter(this._poolCreationSettings) : null;
    ...
    var t = this.getFromPool(),
        r = this;
    return null === t ? void console.log("SPE.Group pool ran out.") : (e instanceof THREE.Vector3 && (t.position.value.copy(e), t.position.value = t.position.value), t.enable(), setTimeout(function () {
      t.disable(), r.releaseIntoPool(t);
    }, 1e3 * Math.max(t.duration, t.maxAge.value + t.maxAge.spread)), this);
  }, o.Group.prototype.triggerPoolEmitter = function (e, t) {
    "use strict";

    if ("number" == typeof e && e > 1) for (var r = 0; r < e; ++r) this._triggerSingleEmitter(t);else this._triggerSingleEmitter(t);
    return this;
    ...
    if (this._updateUniforms(a), this._resetBufferRanges(), 0 !== i || !1 !== this._attributesNeedRefresh || !1 !== this._attributesNeedDynamicReset) {
    ...
    e = t.ensureTypedArg(e, r.OBJECT, {}), e.position = t.ensureTypedArg(e.position, r.OBJECT, {}), e.velocity = t.ensureTypedArg(e.velocity, r.OBJECT, {}), e.acceleration = t.ensureTypedArg(e.acceleration, r.OBJECT, {}), e.radius = t.ensureTypedArg(e.radius, r.OBJECT, {}), e.drag = t.ensureTypedArg(e.drag, r.OBJECT, {}), e.rotation = t.ensureTypedArg(e.rotation, r.OBJECT, {}), e.color = t.ensureTypedArg(e.color, r.OBJECT, {}), e.opacity = t.ensureTypedArg(e.opacity, r.OBJECT, {}), e.size = t.ensureTypedArg(e.size, r.OBJECT, {}), e.angle = t.ensureTypedArg(e.angle, r.OBJECT, {}), e.wiggle = t.ensureTypedArg(e.wiggle, r.OBJECT, {}), e.maxAge = t.ensureTypedArg(e.maxAge, r.OBJECT, {}), e.onParticleSpawn && console.warn("onParticleSpawn has been removed. Please set properties directly to alter values at runtime."), this.uuid = THREE.Math.generateUUID(), this.type = t.ensureTypedArg(e.type, r.NUMBER, o.distributions.BOX), this.position = {
    ...
    this.bufferUpdateRanges = {}, this.attributeKeys = null, this.attributeCount = 0, t.ensureValueOverLifetimeCompliance(this.color, i, i), t.ensureValueOverLifetimeCompliance(this.opacity, i, i), t.ensureValueOverLifetimeCompliance(this.size, i, i), t.ensureValueOverLifetimeCompliance(this.angle, i, i);
  }, o.Emitter.constructor = o.Emitter, o.Emitter.prototype._createGetterSetters = function (e, t) {
    "use strict";
      ...
      Object.defineProperty(e, a, {
        ...
        set: function (e) {
          return function (i) {
            ...
            "_rotationCenter" === e ? (r.updateFlags.rotationCenter = !0, r.updateCounts.rotationCenter = 0) : "_randomise" === e ? r.resetFlags[a] = i : (r.updateFlags[a] = !0, r.updateCounts[a] = 0), r.group._updateDefines(), this[e] = i, Array.isArray(s) && o.utils.ensureValueOverLifetimeCompliance(r[t], n, n);
          };
        }(i)
      });
    }
    ...
    switch (h) {
      ...
      case u.SPHERE:
        r = this.attributes.position.typedArray.array, n = 3 * e, i = r[n], a = r[n + 1], s = r[n + 2], l.randomDirectionVector3OnSphere(this.attributes[t], e, i, a, s, this.position._value, p._value.x, p._spread.x);
        break;
    ...
    this.attributes.rotation.typedArray.setVec3Components(e, o.utils.getPackedRotationAxis(this.rotation._axis, this.rotation._axisSpread), o.utils.randomFloat(this.rotation._angle, this.rotation._angleSpread), this.rotation._static ? 0 : 1), this.attributes.rotationCenter.typedArray.setVec3(e, this.rotation._center);
    ...
    for (var t, r, i = this.resetFlags, a = this.updateFlags, o = this.updateCounts, s = this.attributeKeys, n = this.attributeCount - 1; n >= 0; --n) t = s[n], r = a[t], !0 !== i[t] && !0 !== r || (this._assignValue(t, e), this._updateAttributeUpdateRange(t, e), !0 === r && o[t] === this.particleCount ? (a[t] = !1, o[t] = 0) : 1 == r && ++o[t]);
    ...
    for (var a, o, s, n, u = t - 1; u >= e; --u) a = 4 * u, 0 !== (n = r[a]) && (s = r[a + 1], o = r[a + 2], 1 === this.direction ? (s += i) >= o && (s = 0, n = 0, this._decrementParticleCount()) : (s -= i) <= 0 && (s = o, n = 0, this._decrementParticleCount()), r[a] = n, r[a + 1] = s, this._updateAttributeUpdateRange("params", u));
  }, o.Emitter.prototype._activateParticles = function (e, t, r, i) {
    "use strict";

    for (var a, o, s = this.direction, n = e; n < t; ++n) a = 4 * n, 0 != r[a] && 1 !== this.particleCount || (this._incrementParticleCount(), r[a] = 1, this._resetParticle(n), o = i * (n - e), r[a + 1] = -1 === s ? r[a + 2] - o : o, this._updateAttributeUpdateRange("params", n));
...
},{}]},{},["aa682a65de516c6a89d218144bb70545","b88ced830de1fd4a4f89fa862763f707"], null)

//# sourceMappingURL=aframe-particle-system-component.min.8f5d107b.js.map
